      ...
      <Layout avatar className="pt-16">
        <div className="col-span-16 lg:col-start-1 lg:col-end-11">
          ...
          {Array(10)
            ...
            .map((e, i) => (
              <div
                className="w-full flex flex-col space-y-2 my-10 border-2 px-8 py-10 cursor-pointer hover:shadow-md"
                key={"card-" + i}
              >
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="p-0.5 px-2 rounded-full border-2 text-gray-500 text-xs">
                    React
                  </span>
                  <span className="p-0.5 px-2 rounded-full border-2 text-gray-500 text-xs">
                    React
                ...
                <Link href={"/asd"}>
                  <a className="text-primary-400 text-sm font-semibold">
                    Continuar...
                  </a>
                </Link>
              </div>
        ...
        <div className="col-span-16 lg:col-start-13 lg:col-span-4 relative">
          <div className="sticky ">
            ...
            {Array(3)
              ...
              .map((e, i) => (
                <div
                  className="w-full flex flex-col space-y-2 my-4 border-2 p-6"
                  key={"card2-" + i}
                >
                  <h3 className="font-semibold text-md">Javascript Ejemplo</h3>
                  <span className="text-normal text-xs text-gray-500">
                    10-12-2021{" "}
                  </span>
                  <p className="line-clamp-3 text-sm text-gray-500">
                    {`
